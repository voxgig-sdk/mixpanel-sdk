...
type Args struct {
	Entity string         `json:"entity" jsonschema:"engage"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MixpanelSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "mixpanel_list",
		Description: "List records from Mixpanel. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "mixpanel_load",
		Description: "Load a single record from Mixpanel. " +
...
func runOp(client *sdk.MixpanelSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MixpanelSDK, name string) (sdk.MixpanelEntity, error) {
	switch strings.ToLower(name) {
	case "engage":
		return client.Engage(nil), nil
