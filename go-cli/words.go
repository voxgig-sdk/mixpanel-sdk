...
func registerSDKWords(r *eng.Registry, client *sdk.MixpanelSDK) {
...
func runOp(client *sdk.MixpanelSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
