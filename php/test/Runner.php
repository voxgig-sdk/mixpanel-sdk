...
class MixpanelTestRunner
{
    ...
    {
        $live = self::getenv('MIXPANEL_TEST_LIVE');
        $override = self::getenv('MIXPANEL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MIXPANEL_TEST_EXPLAIN');
...
class_alias('MixpanelTestRunner', 'Runner');
class_alias('MixpanelHelpers', 'Helpers');
