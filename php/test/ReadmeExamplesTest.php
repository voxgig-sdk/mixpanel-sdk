...
// Mixpanel SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MixpanelSDK::test)
...
{
    private const SDK_CLASS = 'MixpanelSDK';
    ...
    private const SDK_BASE = 'mixpanel_sdk';
