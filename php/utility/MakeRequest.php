...
// Mixpanel SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MixpanelMakeRequest
{
    public static function call(MixpanelContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MixpanelResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MixpanelResponse($fetched);
        } else {
