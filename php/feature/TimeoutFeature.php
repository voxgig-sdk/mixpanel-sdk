...
class MixpanelTimeoutFeature extends MixpanelBaseFeature
{
    ...
    private function _with_timeout(MixpanelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MixpanelContext $_ctx, float $ms): void
    {
        $client = $this->client;
