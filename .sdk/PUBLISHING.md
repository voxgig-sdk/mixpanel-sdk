...
|---|---|---|
| `js/` | @voxgig-sdk/mixpanel-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/mixpanel | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mixpanel-js \
      --repository voxgig-sdk/mixpanel-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mixpanel-js` shows it, and
`npm trust revoke @voxgig-sdk/mixpanel-js --id=<id>` removes it.
