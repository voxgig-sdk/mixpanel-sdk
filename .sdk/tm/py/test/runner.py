...
class MixpanelTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MixpanelTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MixpanelTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MixpanelTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
