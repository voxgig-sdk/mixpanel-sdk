...
from projectname_sdk import MixpanelSDK
from projectname_sdk.core.spec import MixpanelSpec
from projectname_sdk.core.result import MixpanelResult
from projectname_sdk.core.response import MixpanelResponse
from projectname_sdk.core.operation import MixpanelOperation
from projectname_sdk.core.error import MixpanelError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import MixpanelBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = MixpanelSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = MixpanelSDK.test(None, None)
        ...
        class TestInitFeature(MixpanelBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MixpanelBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MixpanelSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MixpanelSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MixpanelSDK.test(None, setup_opts)
