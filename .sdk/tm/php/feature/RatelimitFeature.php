...
// Mixpanel SDK ratelimit feature
...
class MixpanelRatelimitFeature extends MixpanelBaseFeature
{
    ...
    private function _acquire(MixpanelContext $ctx): void
    {
    ...
    private function _track(MixpanelContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
