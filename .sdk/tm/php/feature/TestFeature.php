...
// Mixpanel SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MixpanelTestFeature extends MixpanelBaseFeature
{
    ...
    public function init(MixpanelContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MixpanelContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MixpanelContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MixpanelContext $ctx, $op, $args): array
    {
