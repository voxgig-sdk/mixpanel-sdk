...
class MixpanelPagingFeature extends MixpanelBaseFeature
{
    ...
    private function _graphql_pre_request(MixpanelContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(MixpanelContext $ctx): bool
    {
