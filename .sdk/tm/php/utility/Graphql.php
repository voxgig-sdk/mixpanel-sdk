...
class MixpanelGraphql
{
    ...
    // equivalent.
    public static function body(MixpanelContext $ctx): mixed
    {
    ...
    public static function errors(MixpanelContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
