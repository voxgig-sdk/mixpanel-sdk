...
class MixpanelFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MixpanelSDK/1.0)';
    ...
    public static function call(MixpanelContext $ctx, string $fullurl, array $fetchdef): array
    {
