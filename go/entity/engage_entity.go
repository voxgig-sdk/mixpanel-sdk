...
import (
	...
	vs "github.com/voxgig-sdk/mixpanel-sdk/go/utility/struct"
)

type EngageEntity struct {
	name    string
	client  *core.MixpanelSDK
...
func NewEngageEntity(client *core.MixpanelSDK, entopts map[string]any) *EngageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EngageEntity) GetName() string { return e.name }
...
func (e *EngageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EngageEntity) Deleted() bool {
	return e.deleted
}


func (e *EngageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEngageEntity(e.client, opts)
}

func (e *EngageEntity) Data(args ...any) any {
...
func (e *EngageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Engage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EngageEntity) DataTyped(data ...Engage) Engage {
	if len(data) > 0 {
		return typedFrom[Engage](e.Data(asMap(data[0])))
	}
	return typedFrom[Engage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Engage (all fields
// optional at the wire level).
func (e *EngageEntity) MatchTyped(match ...Engage) Engage {
	if len(match) > 0 {
		return typedFrom[Engage](e.Match(asMap(match[0])))
	}
	return typedFrom[Engage](e.Match())
}
...
func (e *EngageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EngageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EngageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EngageEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EngageCreateData and returns an Engage. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EngageEntity) CreateTyped(reqdata EngageCreateData, ctrl map[string]any) (Engage, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Engage{}, err
	}
	return typedFrom[Engage](res), nil
}



func (e *EngageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EngageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EngageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
