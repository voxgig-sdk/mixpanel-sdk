# Mixpanel SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MixpanelSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MixpanelSDK(...) and MixpanelSDK.test(...) become
#      MixpanelSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mixpanel_sdk"
_SDK_CLASS = "MixpanelSDK"
