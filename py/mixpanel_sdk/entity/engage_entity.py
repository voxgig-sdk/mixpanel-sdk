...
from mixpanel_sdk.mixpanel_types import (
    Engage,
    EngageCreateData,
)
...
class EngageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EngageEntity(self._client, opts)
    ...
    def create(self, reqdata: EngageCreateData, ctrl=None) -> Engage:
        utility = self._utility
