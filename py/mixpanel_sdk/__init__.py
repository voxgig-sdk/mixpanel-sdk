...
from mixpanel_sdk.utility import register

# Load features
from mixpanel_sdk.feature.base_feature import MixpanelBaseFeature
from mixpanel_sdk.features import _has_feature, _make_feature
...
class MixpanelSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MixpanelUtility()
        self._utility = utility

        from mixpanel_sdk.config import shared_config
    ...
    def get_utility(self):
        return MixpanelUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MixpanelSDK: graphql: " + str(msg))
            res["graphql"] = errors

        return res


    def Engage(self, data=None) -> "EngageEntity":
        """Entity factory: client.Engage().list() / client.Engage().load({"id": ...})."""
        from mixpanel_sdk.entity.engage_entity import EngageEntity
        return EngageEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MixpanelSDK":
        if sdkopts is None:
            sdkopts = {}
