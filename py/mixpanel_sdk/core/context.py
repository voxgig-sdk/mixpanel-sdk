...
from mixpanel_sdk.core.control import MixpanelControl
...
from mixpanel_sdk.core.helpers import get_ctx_prop, to_map
...
class MixpanelContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, MixpanelResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MixpanelResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MixpanelError(code, msg, self)
